...
const AnimePage = () => {
  ...
  const { editId, setEditId } = useModalContext();

  const fetchMovies = async (searchTerm = "", currentPage = 1) => {
    setLoading(true);
    const params = new URLSearchParams({ type: "anime", page: currentPage.toString() });
    if (searchTerm.trim()) {
    ...
    <div className="w-full mx-auto px-4 py-8">
      ...
      {loading ? (
        ...
        <>
          ...
          {/* Pagination Controls (Prev / Dropdown / Next) */}
