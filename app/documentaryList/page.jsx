...
const DocumentaryPage = () => {
  ...
  const fetchMovies = async (searchTerm = "") => {
    setLoading(true);
    const params = new URLSearchParams({ type: "documentary" });
    if (searchTerm.trim()) {
  ...
  return (
    <div className="w-full mx-auto px-4 py-8">
      <div className="flex justify-between items-center mb-6">
        <h1 className="text-3xl font-bold">All Documentaries</h1>
      ...
      {loading ? (
        ...
        <div className="text-center py-20">
          <p className="text-gray-500 text-lg">No Documentaries Found.</p>
        </div>
      ) : (
